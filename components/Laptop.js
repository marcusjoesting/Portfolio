      ...
      <group rotation-x={-0.425} position={[0, -0.04, 0.41]}>
        <group position={[0, 2.96, -0.13]} rotation={[Math.PI / 2, 0, 0]}>
          ...
          <mesh geometry={nodes['Cube008_2'].geometry}>
            ...
            <Html className="content" rotation-x={-Math.PI / 2} position={[0, 0.05, -0.08]} transform occlude>
              <div className="wrapper bg-gradient-to-r from-blue-300 to-green-300 ">
                <LapHero/>
                <Projects/>
                <Skills/>
                <AboutMe/>
...
export default function App() {
  return (
    <Canvas dpr={[1, 2]} camera={{ position: [-10, 0, -30], fov: 40 }}>
